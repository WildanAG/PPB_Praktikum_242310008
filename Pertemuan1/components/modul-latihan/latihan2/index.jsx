...
import { View, Text, StyleSheet } from "react-native"; // ✅ Fix 1
...
const Latihan2 = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text>{criteria_point ? "Eligible" : "Ineligible"}</Text> {/* ✅ Fix 4 */}
        </View>
    );
};

const styles = StyleSheet.create({ // ✅ Fix 3
    container: {
        flex: 1,
        backgroundColor: '#fff',
        alignItems: 'center',
